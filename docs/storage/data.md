...
* [**Storage on Klone**](./gscratch.md)
* [**Storage on Tillicum**](/docs/tillicum/storage.md)
...
:::important
You have to copy your data to Lolo to be 3-2-1 compliant or to use your own archive solution, it does not happen automatically. [**See our Lolo documentation for more information**](/docs/lolo/lolo.md).
:::
