...
Storage for your data works a little bit different on a supercomputer compared to your desktop. A high-level introduction can be found [<ins>**below**</ins>](#what-is-storage-for-a-supercomputer). This page also covers [<ins>**best practices**</ins>](#3-2-1-policy) around how to handle your data, this is the 3-2-1 policy. Each Hyak cluster has its own storage.
