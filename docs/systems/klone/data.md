...
* [**Storage on Klone**](./storage.md)
* [**Storage on Tillicum**](/docs/systems/tillicum/storage)
...
:::note
3-2-1 is a general IT best practice see the following references: [**Backblaze**](https://www.backblaze.com/blog/the-3-2-1-backup-strategy/), [**Acronis**](https://www.acronis.com/en-us/articles/backup-rule/), and [**Networkworld**](https://www.networkworld.com/article/3527303/for-secure-data-backup-here-s-how-to-do-the-3-2-1-rule-right.html).
:::
...
:::important
You have to copy your data to Lolo to be 3-2-1 compliant or to use your own archive solution, it does not happen automatically. [**See our Lolo documentation for more information**](/docs/systems/lolo/overview).
:::
