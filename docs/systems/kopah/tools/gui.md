...
Globus public sharing is available with [**Kopah S3 storage**](https://uw.service-now.com/it?id=sc_entry&sys_id=f617c851935e565086a27b847aba1018&sysparm_category=d103f865dba2bf40d6a77a8eaf9619b2), making it a dynamic complement for your research storage portfolio if you anticipate requiring regular sharing and collaboration.
...
* Go to [**globus.org**](https://www.globus.org/) and "LOG IN" with University of Washington. Signing in includes Duo 2-Factor Authentication. 
...
* Once connected, you will see the KopahS3 buckets created while using your Kopah account. The three-line menu can be revealed to show helpful features, expanding it shows the function descriptions. 
...
2. You should see your profile for connecting to **Kopah S3** showing in the drop-down box. Enter your Access Key and Secret Key, which can be found in your home directory on Hyak Klone. When you requested your account, the Kopah team deposited your Kopah keys, in your home directory. 
...
3. Once that is complete, Kopah S3 will appear in your Cyberduck bookmarks or server list. **Connect** by double-clicking on the **Kopah S3** bookmark. 
