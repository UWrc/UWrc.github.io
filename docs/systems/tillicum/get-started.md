---
title: Get Started on Tillicum
---

## Prerequisites

Before getting started on Tillicum, make sure you've completed the common onboarding steps:
...
On Tillicum, computing units are "GPU Hours" and are applied to all jobs scheduled with [**Slurm**](/docs/systems/tillicum/scheduling-jobs).
...
* [**storage**](/docs/systems/tillicum/storage)
* data [**import, export**](/docs/guides/data-transfer/globus)
