...
Windows
-------
1. Install an X Server on your Windows machine, we recommend [<ins>**VcXsrv**</ins>](https://sourceforge.net/projects/vcxsrv/).
...
Mac
---
1. Install [<ins>**XQuartz**</ins>](https://www.xquartz.org/) as an X Server on your Mac either through a browser or `brew install xquartz`.
