...
**Support and Documentation -** Assistance with software-related issues is available through the Hyak help desk and ticketing system (email [<ins>help@uw.edu</ins>](help@uw.edu) with “Hyak” in the subject line). Documentation on using the system and supported software is provided to help researchers resolve common issues. 
