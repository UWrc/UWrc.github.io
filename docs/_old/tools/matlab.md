...
The latest Matlab version on `klone` is R2023b. You can use [**LMOD**](modules.md) to load the module then run the binary, be sure to use the `-nodisplay` flag unless you enabled X11 forwarding to get the GUI.
