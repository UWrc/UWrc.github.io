...
### 1. [**Open OnDemand**](https://hyak.uw.edu/docs/ood/apps/jupyter) (Easiest)
...
### Pre-requisites
This method will require a container to get started, look for copies at `/sw/ondemand/containers/jupyter/sifs`, select a container from the `quay.io` registry, or build your own. For more information, read about [**containers on Hyak**](https://hyak.uw.edu/docs/tutorials/containers/background#what-is-a-container).
...
This tutorial assumes you have already completed the [**set up of Miniconda covered here**](https://hyak.uw.edu/docs/guides/software/conda-python#install). Throughout this exercise, it might be helpful to refer to those instructions if you get stuck. 
