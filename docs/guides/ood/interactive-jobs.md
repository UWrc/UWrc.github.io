...
Offered applications are available from the `Interactive Apps` tab. Clicking on an application will open a form where you can specify the resources you need for your job. If you're unfamiliar with the concepts of Accounts and Partitions, check out a brief [**overview**](https://hyak.uw.edu/docs/tutorials/slurm/jobs#accounts-and-partitions).
