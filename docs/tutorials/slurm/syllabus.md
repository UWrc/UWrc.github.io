---
title: Syllabus
pagination_next: tutorials/slurm/jobs
---
...
* Understand how accounts and partitions determine research computing access, and the purpose and usage of the `hyakalloc` command.
...
* [**Syllabus**](https://hyak.uw.edu/docs/tutorials/slurm/syllabus)
* [**Scheduling Jobs**](https://hyak.uw.edu/docs/tutorials/slurm/jobs)
* [**Job Arrays**](https://hyak.uw.edu/docs/tutorials/slurm/arrays)
