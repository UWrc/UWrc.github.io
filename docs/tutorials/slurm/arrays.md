...
Notice the jobs as they appear in your terminal showing `squeue`. [**Click here to return to the Pro Tip box with instructions to Monitor the Slurm Job Queue to set that view up again.**](https://hyak.uw.edu/docs/tutorials/slurm/jobs#monitoring-the-slurm-job-queue)
...
We hope you will be able to adapt these methods to fit your needs and the needs of your research project. If you have any questions or suggestions for how to improve this tutorial, please email [**help@uw.edu**](mailto:help@uw.edu) with "Hyak Slurm Tutorial" in the subject line, and let us know what you think. Thank you!
