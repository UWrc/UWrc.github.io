...
:::warning
If you haven't already, it is critical you complete the [**set up instructions**](https://hyak.uw.edu/docs/tutorials/slurm/advanced#tutorial-materials) to follow along.
:::
