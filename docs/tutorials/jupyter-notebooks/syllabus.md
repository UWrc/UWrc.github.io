...
[**Jupyter via Open OnDemand**](https://hyak.uw.edu/docs/guides/ood/apps/jupyter)

[**Jupyter via SSH port forwarding**](https://hyak.uw.edu/docs/guides/applications/jupyter)

[**Using VS Code on Hyak**](https://hyak.uw.edu/docs/guides/applications/vscode/overview)
...
On that note, your first PRO TIP: Untangling tech jargon is tough, and there's no shortage of essays explaining containers and "containerization" ([**See Additional Resources**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/setup#additional-resources)). We encourage you to educate yourself about containers and other relevant topics as additional learning to accompany this tutorial. 
...
1. [**Getting Started**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/setup)
1. [**Building a Container**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/container)
1. [**Flexible Connections**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/ssh)
1. [**Working in the Overlay**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/overlay)
1. [**Slurm Job & Port Forwarding**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/slurm-forward)
1. [**Start Up Sequence**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/start-up-seq)
1. [**Jupyter in VS Code**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/connect-vsc)
1. [**Interactive Mode**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/interactive)
