...
Like many other parts of this guide, we [**already have instructions**](https://hyak.uw.edu/docs/getting-started/ssh-login#intracluster-ssh-keys) on this, but since we're keeping this guide self-contained, we'll go through it again here:
...
[**Jump to Mac/Linux Instructions**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/ssh#mac-linux-users-a-set-of-customized-local-configurations)

[**Jump to Windows Instructions**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/ssh#windows-users-a-set-of-customized-local-configurations)
