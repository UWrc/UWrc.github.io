...
By this point in the tutorial, we hope you understand that disk storage management is important, as we have stressed [**selecting your working directory**](https://hyak.uw.edu/docs/tutorials/jupyter-notebooks/setup#selecting-your-working-directory). 
