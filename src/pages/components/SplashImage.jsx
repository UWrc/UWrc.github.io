...
export default function SplashImage() {
  ...
  return (
    <svg width="80%" height="48%" viewBox="-20 0 1020 340" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <g id="boxes" transform="translate(350, 50)">
      ...
      <g id="left-circles" transform="translate(30, 80)">
      ...
      <motion.g id="left-arrows" transform="translate(100, 120)" variants={variants} initial="hidden" animate="visible" transition={{ duration: 0.5}}>
        <path fill="none" stroke="#001b3d" strokeWidth="3" markerEnd="url(#arrowhead)" d="M0 60 L210 60" />
        <path fill="none" stroke="#001b3d" strokeWidth="3" d="M90 0 Q130 60 210 60" />
        <path fill="none" stroke="#001b3d" strokeWidth="3" d="M90 120 Q130 60 210 60" />
      </motion.g>
      <g id="right-circles" transform="translate(870, 80)">
      ...
      <motion.g id="right-arrows" transform="translate(690, 80)" variants={variants} initial="hidden" animate="visible" transition={{ duration: 0.5}}>
