    ...
    <svg width="80%" height="48%" viewBox="0 0 1020 340" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <marker id="arrowhead" markerWidth="6" markerHeight="6"
                refX="0" refY="3" orient="auto" fill={isDarkTheme ? "white" : "#001b3d"}>
          <polygon points="0 0, 6 3, 0 6" />
        </marker>
      </defs>
      <rect transform="translate(0, 10)" width={1020} height={330} fill={isDarkTheme ? "url(#dark-mode-white)" : "url(#pink-radial)"} />
      ...
      <motion.g id="left-arrows" transform="translate(120, 120)" variants={variants} initial="hidden" animate="visible" transition={{ duration: 0.5}}>
        <path fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" markerEnd="url(#arrowhead)" d="M0 60 L210 60" />
        <path fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" d="M90 0 Q130 60 210 60" />
        <path fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" d="M90 120 Q130 60 210 60" />
      </motion.g>
      ...
      <motion.g id="right-arrows" transform="translate(710, 80)" variants={variants} initial="hidden" animate="visible" transition={{ duration: 0.5}}>
        <path d="M0 0 L100 0" fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" markerEnd="url(#arrowhead)" strokeDasharray="4" />
        <path d="M0 100 L180 100" fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" markerEnd="url(#arrowhead)" strokeDasharray="4" />
        <path d="M0 200 L100 200" fill="none" stroke={isDarkTheme ? "white" : "#001b3d"} strokeWidth="3" markerEnd="url(#arrowhead)" strokeDasharray="4" />
      </motion.g>
    </svg>
  )
}
