...
<Layout title="Pricing">
  ...
  <h3>Hyak Demonstration Accounts</h3>
            ...
            <ul>
              <li>Jobs may only be submitted to the <a href="https://hyak.uw.edu/docs/compute/checkpoint#the-checkpoint-partition"><ins><b>ckpt, ckpt-g2, or ckpt-all partitions</b></ins></a>.</li>
              <li>Storage is limited under the demo account to <a href="https://hyak.uw.edu/docs/storage/gscratch#user-home-directory"><ins><b>10GB in the home directory</b></ins></a>. For additional temporary storage you may utilize <a href="https://hyak.uw.edu/docs/storage/gscratch#scrubbed"><ins><b>/gscratch/scrubbed storage</b></ins></a>. Be aware that files in scrubbed not used for 21 days will be deleted. This storage in not intended for large datasets, but can be helpful as you try out workflows on Hyak.</li>
            ...
            <a href="https://uwconnect.uw.edu/sp?id=sc_cat_item&sys_id=f5caba8fdbe108101ba12968489619e0"><button class="button button--secondary button--block"><ins>Request a Hyak Demonstration Account</ins></button></a>
