...
Slurm has a command called [**`sbcast`**](https://slurm.schedmd.com/sbcast.html) that is useful for efficiently copying files to all nodes used in a multi-node job as part of an `sbatch` script.
