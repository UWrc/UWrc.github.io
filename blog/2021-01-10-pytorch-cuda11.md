...
[**The Pytorch website**](https://pytorch.org/get-started/locally/) has a nice getting started matrix that generates the requisite install commands against CUDA10.
...
Now we can load the Python interpreter and [**confirm Pytorch is installed**](https://pytorch.org/get-started/locally/#linux-verification) and the CUDA10 compiled library recognizes this GPU with CUDA11. 
