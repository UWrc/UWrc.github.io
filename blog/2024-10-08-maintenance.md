...
[**Tools for Kopah Storage Users**](https://hyak.uw.edu/docs/storage/kopah) - We have installed [**Command Line Interface tools**](https://hyak.uw.edu/docs/storage/cli) like `s3cmd` and `s5cmd` on `klone` and provide instructions for using [**Python library `boto3` for Kopah interaction and retrieval**](https://hyak.uw.edu/docs/storage/boto3) to build Kopah S3 storage usage into your research computing applications on Hyak. 

If you have any issue using these tools, please open a ticket by emailing [**help@uw.edu**](mailto:help@uw.edu) with "Hyak" in the subject line. We appreciate any feedback about how to improve ease of use for tools presented in our documentation.
...
If you would like to request 1 on 1 help, please send a ticket to [**help@uw.edu**](mailto:help@uw.edu) with "Hyak Office Hour" in the subject line to coordinate a meeting with Kristen.

Please don't hesitate to reach out to the Hyak team with issues and feedback by opening a ticket by emailing [**help@uw.edu**](mailto:help@uw.edu) with "Hyak" in the subject. 
