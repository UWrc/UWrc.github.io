...
During June's maintenance, we've refreshed the operating system images for both login and compute nodes, and we've responded to user feedback with a solution to make Cron jobs persistent. Good news: we are holding office hours all summer to support your research grind. Stay informed by subscribing to our [**mailing list**](https://mailman1.u.washington.edu/mailman/listinfo/hyak-users) and the [**UWIT Research Computing Events Calendar**](https://calendar.washington.edu/sea_uwit-rc). The next maintenance is scheduled for **Tuesday July 8, 2025** (AKA the 2nd Tuesday of the month).
...
* **Cron job system improvements** – our users provided feedback that their Cron jobs were being lost after monthly maintenance. We resolve this:  
	...
	* We recommend `scrontab` for routine operations. [**Learn more from Slurm**](https://slurm.schedmd.com/scrontab.html). [**Learn more from NERSC**](https://docs.nersc.gov/jobs/workflow/scrontab/).  
...
[**2025 RCC Usage Check-In Form**](https://forms.office.com/r/z48tU08YQU)
...
If you missed our recent Data Storage Day on May 5, we’ve published the full set of demonstration videos on our [**YouTube Playlist**](https://www.youtube.com/playlist?list=PL-uLiqrTav1omqc7omKsLzRg2ng3nKCtj). Topics covered and relevant links: 

* [**Introduction to Kopah: What It Is and Why It Matters**](https://youtu.be/9UyGFIN_kn8)
    * [**Kopah documentation**](https://hyak.uw.edu/docs/storage/kopah/)
* [**Kopah Eligibility and Access**](https://youtu.be/lPdiV2SkIGw)
    * [**Kopah Service Catalog and Link to Cost Calculator**](https://uw.service-now.com/it?id=sc_entry&amp;sys_id=f617c851935e565086a27b847aba1018&amp;sysparm_category=d103f865dba2bf40d6a77a8eaf9619b2)
* [**Working with s3cmd and s5cmd**](https://youtu.be/xT2RcNrvTPw)
    * [**s3/s5cmd walk though**](https://hyak.uw.edu/docs/storage/cli)
* [**Using Globus with Kopah**](https://youtu.be/bheKdLOvSs4)
    * [**Globus instructions**](https://hyak.uw.edu/docs/storage/gui)
* [**Mounting Kopah with JuiceFS**](https://youtu.be/0Bsk9-Bpp0c)
    * [**JuiceFS info**](https://hyak.uw.edu/docs/storage/juicefs)
* [**Accessing Kopah with Python and boto3**](https://youtu.be/yBgZAU_qyRg)
    * [**Boto3 guide**](https://hyak.uw.edu/docs/storage/boto3)
...
* [**Register here**](https://artsci.washington.edu/news/events?_gl=1*xft39z*_ga*NjEyOTczOTkxLjE3MzY1NDg1NTg.*_ga_3T65WK0BM8*czE3NDg5ODU2ODckbzg0JGcxJHQxNzQ4OTg1OTc5JGo2MCRsMCRoMA..*_gcl_au*ODExMjgwMzkuMTc0NDM5NjY4NQ..*_ga_JLHM9WH4JV*czE3NDg5ODU2ODckbzg0JGcxJHQxNzQ4OTg1OTc5JGo2MCRsMCRoMA&trumbaEmbed=view%3Devent%26eventid%3D182996705)
